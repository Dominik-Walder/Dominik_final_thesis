...
extern void FMSTR_SerialIsr              (void);
...
(uint32_t) &SIU_EIRQ4_15_Isr, /* Vector #  50 SIU_EIISR[EIF15:EIF4] SIU SIU External Interrupt Flags 15-4 */
...
(uint32_t) &eTPU_AS_Isr, /* Vector #  96 ETPU_CISR_A[CIS28] eTPU_A eTPU Engine A Channel 28 Interrupt Status */
